    ...
    return (
		<div className="bg-white/20 backdrop-blur-2xl max-h-screen overflow-hidden h-screen sm:grid sm:place-content-center">
			<div className="sm:w-4/5 md:w-1/2 sm:mx-auto grid gap-6 gap-x-6 text-center translate-y-1/3 sm:translate-y-0">
				...
				<p className="text-brand-blue font-medium rounded py-1 px-3 inline-block mx-auto bg-brand-blue/10 duration-500 animate-pulse w-fit backdrop-blur-2xl text-lg text-center">
					404 error
				</p>
				...
				<p>
					...
					moved. We’re still developing the site though, so be sure to
					check back later.
				</p>
			</div>
		</div>
