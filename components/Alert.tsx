...
const Alert: React.FC<IAlert> = ({
	...
	return (
		<div
			className={cn(
				"bg-white shadow-[0px_5px_10px_0px_#0000000D] fixed top-6 left-6 w-[calc(100%-3rem)] isolate rounded-lg px-3.5 py-6 flex items-center gap-8 border-l-8 sm:right-[15%] transition-transform -translate-y-[250%] duration-300 ease-linear sm:left-auto sm:w-[calc(70%)] lg:right-16 lg:w-[calc(50%-12rem)] z-[1024] xl:right-[5%] xl:w-[calc(50%-25%)] 2xl:right-[10%]",
				{
