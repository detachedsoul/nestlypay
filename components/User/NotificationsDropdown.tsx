...
const NotificatonsDropdown: React.FC<notificationProps> = ({ isOpen }: notificationProps) => {
    return (
        <div className={`bg-white absolute space-y-4 w-[calc(100vw-3rem)] right-0 top-[calc(100%+1.5rem)] p-4 rounded-lg transition-transform ease-in-out duration-500 shadow-2xl lg:w-[calc(100vw-50rem)] ${isOpen ? "translate-y-0" : "-translate-y-[300%]"}`}>
